...
<main>
    <section class="container">
        ...
        <div class="btn_sendgmail">
            <a target="_blank" href="send_gmail.php">
                <button class="btn_mail">Send_Gmail</button>
            </a>
            <div class="gmailsetting">  
                <a href="recipients_setting.php">
                    <img id="gear" src="./Picture/gear.png" alt="">
                </a>
            </div>
        </div>
    </section>
